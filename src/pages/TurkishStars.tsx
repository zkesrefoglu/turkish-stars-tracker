        ...
        <div className="flex flex-col gap-4 mb-8">
          {athletes.map((athlete) => {
            ...
            return (
              ...
              >
                <Card className={`border-border overflow-hidden cursor-pointer transition-all duration-300 hover:scale-[1.01] hover:shadow-xl hover:border-accent/40 ${athlete.slug === "alperen-sengun" ? "bg-[#FFEEEE]" : athlete.sport === "basketball" ? "bg-red-950/20 border-red-900/30" : "bg-card"}`}>
